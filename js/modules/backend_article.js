                ...
                if (articleData) {
                    ...
                    if (lightboxContent) {
                        lightboxContent.innerHTML = `
                            ...
                            <p><span>${articleData.title}</span></p>
                            <p><span>${articleData.text}</span></p>
                            <p><span>${articleData.first_name} ${articleData.last_name}</span></p>
                            <p><span>${articleData.about}</span></p>
                            </div>
                        `;
