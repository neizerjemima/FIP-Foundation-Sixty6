...
$stmtRoles = $connection->prepare($queryRoles);
$stmtRoles->execute();
$roles = $stmtRoles->fetchAll(PDO::FETCH_ASSOC);

// Query to fetch volunteer details including role_name
$queryVolunteer = 'SELECT v.*, r.name as role_name 
                   FROM volunteers v 
                   LEFT JOIN roles r ON v.role = r.id 
                   WHERE v.id = :volunteerId';

$stmtVolunteer = $connection->prepare($queryVolunteer);
$volunteerId = $_GET['id'];
$stmtVolunteer->bindParam(':volunteerId', $volunteerId, PDO::PARAM_INT);
...
<body class="user-website" data-page="volunteer-edit-cms">
    ...
    <section class="grid-con">
        ...
        <div class="col-start-2 col-end-5 m-col-start-6 m-col-end-13 xl-col-start-7 xl-col-end-13 buttons-more-info">
            <a href="volunteer_more.php?id=<?php echo $row['id']; ?>"><button>Go Back</button></a>
        </div>
        ...
        <div class="col-span-full more-information-section">
            <form action="edit_volunteer.php" method="POST">
                ...
                <div class="more-information">
                    ...
                    <select name="role" class="dropdown-userinter">
