...
$stmt = $connection->prepare('SELECT v.*, r.first_name AS author_fname, r.last_name AS author_lname FROM articles v JOIN authors r ON v.author = r.id WHERE v.id = :articleId');
$articleId = $_GET['id'];
    ...
    <main class="content-user">
        ...
        <section class="grid-con">
            ...
            <div class="col-start-2 col-end-5 m-col-start-6 m-col-end-13 xl-col-start-7 xl-col-end-13 buttons-more-info">
               ...
               <a href="article_edit.php?id=<?php echo $row['id']; ?>"><button>Edit</button></a>
            </div>
            ...
            <div class="col-span-full more-information-section">
                ...
                <div class="more-information more-information-flex">
                    <h3>Phrase:</h3>
                    <p><?php echo $row['attention_phrase']; ?></p>
                </div>
                <div class="more-information more-information-long">
                    <h3 class="text-more">Text:</h3>
