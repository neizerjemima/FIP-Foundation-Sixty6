    ...
    <main class="content-user">
        ...
        <section class="grid-con">
            ...
            <div class="col-start-2 col-end-5 m-col-start-6 m-col-end-13 xl-col-start-7 xl-col-end-13 buttons-more-info">
                <a href="article_add_form.php"><button>CREATE</button></a>
                                ...
                                <tr class="column-names">
                                    ...
                                    <td class="dropdown-table">
                                        <select class="dropdown-select">
                                            <option value="email-volunteer">Author</option>
                                            <option value="message-volunteer">Headline</option>
                                            <option value="message-volunteer">Text</option>
                                        </select>
                                    </td>
                                ...
                                <?php
                                 ...
                                 while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    echo 
                                        '<td>'.$row['title'].'</td>
                                        <td>'.$row['image'].'</td>
                                        <td class="email-volunteer">'.$row['author_fname'].' '.$row['author_lname'].'</td>
                                        <td class="email-volunteer">'.$first_three_words_phrase.'...</td>
