...
$stmt = $connection->prepare('SELECT * FROM events ORDER BY created_at ASC');
$stmt->execute();
?>
                                 ...
                                 while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    echo 
                                        ...
                                        <td class="buttons-column">
                                            <a href="events_more.php?id='.$row['id'].'"><button class="button-table-general">More</button></a>
                                            <a href="events_edit.php?id='.$row['id'].'"><button class="button-table-general">Edit</button></a>
                                            <a href="delete_events.php?id='.$row['id'].'"><button class="button-table-general">Delete</button></a>
                                        </td>
                                    </tr>';
                                 }
